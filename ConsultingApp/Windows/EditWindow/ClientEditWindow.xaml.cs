...
namespace ConsultingApp
{
    public partial class ClientEditWindow : Window
    {
        ...
        public ClientEditWindow(MyDbContext context, Client client, Action reloadMethod)
        {
            InitializeComponent();
            _context = context;
            _client = client;
            ...
            // Заполнить поля данными клиента
            NameCompanyTextBox.Text = _client.Name;
        ...
        {
            _client.Name = NameCompanyTextBox.Text;
            ...
            DataOperations.UpdateRow(_context, _client, _reloadMethod);
            Close();
        }
